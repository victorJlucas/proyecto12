	...
	<div class="card-body">
		<form action="<?= ROOT ?>adminuser/update/<?= $data['data']->id ?>" method="POST">
			...
			<div class="form-group text-left">
				...
				<input type="password" name="password1" class="form-control" placeholder="Introduce tu contraseña (dejar en blanco si no desea cambiarla)">
			</div>
			<div class="form-group text-left">
				<label for="password2">Repetir contraseña:</label>
				<input type="password" name="password2" class="form-control" placeholder="Repite tu contraseña (solo en caso de cambio)">
			</div>
